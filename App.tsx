      ...
      <main role="main" className="pt-40">
        ...
        <section className="px-8 py-64 bg-white text-center relative overflow-hidden border-t-4 border-black">
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <button className="bg-black text-white font-anton text-5xl px-20 py-10 hover:bg-[#BC0000] transition-all transform hover:-translate-y-4 shadow-[20px_20px_0px_0px_rgba(188,0,0,1)]">
              {t.common.subscribe}
            </button>
          </div>
      ...
      <footer className="bg-[#F2F0EB] px-8 py-32 border-t-4 border-black">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-24">
          <div className="lg:col-span-6">
            <span className="font-anton text-7xl block mb-12 uppercase tracking-tighter">THE MOVMENT</span>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="flex flex-col gap-4 font-anton text-2xl">
              ...
              <li><button onClick={() => dispatch({type:'SET_VIEW', payload:'finances'})}>TRANSPARENCE</button></li>
            </ul>
          </div>
          <div className="lg:col-span-3">
