      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center">
        <div className="bg-[#BC0000] px-8 py-4 flex items-center shrink-0 border-r border-white/10">
          <div className="flex flex-col">
            <span className="font-anton text-xl tracking-widest leading-none text-white">ÉTAT DU CAPITAL</span>
            <span className="font-mono text-[9px] font-bold tracking-[0.3em] opacity-80 mt-1 uppercase text-white">Souveraineté technique</span>
          </div>
        </div>
        ...
        <div className="flex-grow px-8 py-4 md:py-0 flex items-center gap-10 overflow-hidden">
          ...
          <div className="shrink-0 flex flex-col items-end">
             <span className="font-mono text-[9px] uppercase tracking-widest opacity-40 mb-1">Phase 1 : L'Outil</span>
             <span className="font-anton text-5xl text-[#BC0000] leading-none">{percentage}%</span>
          </div>
        </div>

        <button className="bg-white text-black font-anton text-3xl px-12 py-8 hover:bg-[#BC0000] hover:text-white transition-all duration-500 active:scale-95 group relative overflow-hidden cursor-pointer">
